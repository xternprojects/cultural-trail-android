package com.xtern.cultural_trail.adapters;
...
public class IssueDetailAdapter extends RecyclerView.Adapter<IssueDetailAdapter.VersionViewHolder> {
    ...
    public IssueDetailAdapter(List<String> versionModels) {
        isHomeList = false;
    ...
    public VersionViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.map_card_view, viewGroup, false);
